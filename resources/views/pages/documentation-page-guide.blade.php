                        ...
                        <div class="mx-auto flex px-5  md:flex-row flex-col items-center jobcard">
                            ...
                            <div
                                ...
                                <div class="pt-10 px-2 sm:px-6">
                                    <a href="{{route('nodeGuide')}}"><h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-100">Node Management</h1></a>
                                    <p class="text-indigo-200 text-base pb-6">Click on the link to find the step by step guid in managing your display node.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="text-indigo-200 body-font p-5 bg-gray-900">
                        <div class="mx-auto flex px-5  md:flex-row flex-col items-center jobcard">
                            ...
                            <div
                                class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center">
                                <div class="pt-10 px-2 sm:px-6">
                                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-100">2: Content Management</h1>
                    ...
                    <section class="text-indigo-200 body-font p-5 bg-gray-900">
                        <div class="mx-auto flex px-5  md:flex-row flex-col items-center jobcard">
                            ...
                            <div
                                class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center">
                                <div class="pt-10 px-2 sm:px-6">
                                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-100">3: Content Upload</h1>
                                    <p class="text-indigo-200 text-base pb-6">From local banks to local government, we
                                        partner with organizations on their journey to digital transformation. Our
                                        customers include 15 million professionals in 175 countries and 800 of the
                                        fortune 1000.</p>
                    ...
                    <section class="text-indigo-200 body-font p-5 bg-gray-900">
                        <div class="mx-auto flex px-5  md:flex-row flex-col items-center jobcard">
                            ...
                            <div
                                class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center">
                                <div class="pt-10 px-2 sm:px-6">
                                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-100">4: Raspberry Pi Setup</h1>
                                    <p class="text-indigo-200 text-base pb-6">From local banks to local government, we
                                        partner with organizations on their journey to digital transformation. Our
                                        customers include 15 million professionals in 175 countries and 800 of the
                                        fortune 1000.</p>
