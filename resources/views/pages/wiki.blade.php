...
<head>
    ...
    <title>Rural Display System</title>
...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a href="{{ url('/allDisplays') }}" class="text-sm text-gray-700 underline">Dashboard</a>
            @else
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold">
                            <a href="{{route('documentation')}}" class="underline text-gray-900 dark:text-white">
                                Documentation
                            </a>
                        </div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">
                            <a href="{{route('tcs')}}" class="underline text-gray-900 dark:text-white">Terms and Conditions</a>
                        </div>
                    </div>
